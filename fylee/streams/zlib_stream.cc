...
int ZlibStream::read(Buffer::ptr ba, size_t length) {
    throw std::logic_error("ZlibStream::read is invalid");
}
...
int ZlibStream::write(Buffer::ptr ba, size_t length) {
...
fylee::Buffer::ptr ZlibStream::getBuffer() {
    fylee::Buffer::ptr ba(new fylee::Buffer);
    for(auto& i : m_buffs) {
